...
<main class="p-4">
    <section>
        ...
        <svg class="mx-auto mt-10" width="265" height="55" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="w-fit mx-auto mt-10">
            Escribenos al <?= $infosite["whatsapp_number"] ?>
        </div>
        <?php endif ?>
        ...
        <div class="mt-6 w-full max-w-5xl mx-auto bg-green-300 rounded-xl px-8 pt-8 flex justify-between items-center">
            <div class="max-w-sm mb-8 flex flex-col gap-4">
                <h2 class="text-4xl font-medium">Casa de Cambios</h2>
                <p class="text-2xl">Envíos de dinero a Venezuela</p>
                <p>Descomplica tus envíos de Dinero a Venezuela con nosotros. Tambien puedes recibir transferencias desde Venezuela con nosotros a tu Pix.</p>
            </div>
